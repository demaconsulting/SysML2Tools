...
This document contains the requirements for the SysML2 Tools project.

## Purpose

SysML2 Tools is a reference implementation demonstrating best practices for DEMA Consulting
